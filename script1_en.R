...
# Import kml
carrancas <- st_read("E:/Marcelo/3a20222/shp/carrancas.kml")
...
# Export shapefile
st_write(carrancaszm,"E:/Marcelo/3a20222/shp/carrancas.shp", "carrancas.shp")

# Import shapefile using sf
carrancas <- st_read("E:/Marcelo/3a20222/shp/carrancas.shp")
